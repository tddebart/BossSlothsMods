...
namespace BossSlothsCards.Utils
{
    public sealed class CardBarUtils
    {
        ...
        public void ShowCard(int teamID, int cardID)
        {
            ...
            ((GameObject)Traverse.Create(this.PlayersCardBar(teamID)).Field("currentCard").GetValue()).gameObject.transform.localScale = Vector3.one * CardBarUtils.cardLocalScaleMult;
        }
        ...
        internal System.Collections.IEnumerator EndPickPhaseShow()
        {
            foreach (Player player in PlayerManager.instance.players)
            {
                ...
                {
                    this.PlayersCardBar(player).gameObject.transform.localScale = Vector3.one * CardBarUtils.barlocalScaleMult;
        ...
        internal System.Collections.IEnumerator ShowImmediate(int teamID, int cardID)
        {
            ...
            this.PlayersCardBar(teamID).gameObject.transform.localScale = Vector3.one * CardBarUtils.barlocalScaleMult;
        ...
        private static void RPCA_ClearCardBar(int actorID)
        {
            ...
            CardBarUtils.instance.PlayersCardBar(playerToReset.teamID).ClearBar();
        }
    }
